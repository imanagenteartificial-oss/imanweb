          ...
          <NeonCard glowColor="primary" className="bg-black/60 border-primary/50 relative overflow-visible">
            ...
            <div className="text-center pt-8 pb-8 border-b border-white/10">
              ...
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-5xl md:text-6xl font-orbitron font-bold text-white">$450</span>
            ...
            <div className="py-8 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-muted-foreground font-exo text-sm">Incluye CRM con embudo de ventas y etiquetas, segumientos al lead tipo humano, envio de promocion publicidad al cliente, se integra con Messenger de facebook, y con DM de instagram, incluye Agente de creacion de contenido y publicacion para redes sociales Facebook e Instagram.</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-primary/20 flex items-center justify-center shrink-0 mt-0.5">
                  <Check className="w-3.5 h-3.5 text-primary" />
