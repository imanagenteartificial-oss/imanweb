              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground font-exo text-sm leading-relaxed">
                      Conexión directa con Facebook Ads para filtrar y mostrar anuncios solo a interesados reales. Multiplica tus ventas con un "vendedor estrella" que nunca duerme.
                    </p>
                  </div>
                </div>
              </div>
